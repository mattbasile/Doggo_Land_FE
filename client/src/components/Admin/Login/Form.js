    ...
    return (
        <section className="login-form flex">
            ...
            <form className=" w-1/2 flex flex-col ">
                ...
                <input name="username" value={props.username} onChange={(e)=>props.handleInput(e)} className="mx-16 rounded p-2 mb-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text"/>
                <label className=" px-16 block text-blue-900 text-sm font-semibold mb-2 ">Password:</label>
                <input name="password" value={props.password} onChange={(e)=>props.handleInput(e)} className="mx-16 rounded p-2 mb-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="password"/>
                ...
                <button onClick={(e)=>{props.handleLogin(e)}} className="bg-white px-16 mt-8 text-2xl font-bold py-1 rounded mx-auto text-blue-900 hover:text-white hover:bg-blue-900">Submit</button>
            </form>
            :
            (<form className=" w-1/2 flex flex-col ">
                <h3 className="text-center text-3xl body-font font-bold text-blue-900 mt-16">Thank you for helping us find homes!</h3>
                ...
                <input name="kennel_name" value={props.kennel_name}onChange={(e)=>props.handleInput(e)} className="mx-16 rounded p-2 mb-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text"/>
                ...
                <button onClick={(e)=>{props.handleRegister(e)}}className="bg-white px-16 mt-8 text-2xl font-bold py-1 rounded mx-auto text-blue-900 hover:text-white hover:bg-blue-900">Register</button>
            </form>)
            }
