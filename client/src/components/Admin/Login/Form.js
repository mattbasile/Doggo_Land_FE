    ...
    return (
        <section className="login-form flex">
            ...
            <form className=" w-1/2 flex flex-col ">
                ...
                <input className="mx-16 rounded p-2 mb-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text"/>
                <label className=" px-16 block text-blue-900 text-sm font-semibold mb-2 ">Password:</label>
                <input className="mx-16 rounded p-2 mb-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="password"/>
